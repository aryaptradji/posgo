<x-layout>
    ...
    <div class="w-full bg-tertiary rounded-2xl shadow-outer mt-12" x-data="{
        search: '',
        outcomes: [
            { tanggal: '30 Sep 2024', sumber: 'Beli Stok Teh Botol', status: 'Operasional', total: 120000 },
            { tanggal: '29 Sep 2024', sumber: 'Bayar Karyawan', status: 'Operasional', total: 2000000 },
            { tanggal: '29 Sep 2024', sumber: 'Bayar Listrik', status: 'Operasional', total: 200000 },
            { tanggal: '28 Sep 2024', sumber: 'Donasi Anak Yatim', status: 'Luar Operasional', total: 300000 },
            { tanggal: '27 Sep 2024', sumber: 'Biaya Perbaikan', status: 'Operasional', total: 70000 }
        ],
        currentPage: 1,
        perPage: 5,
        open: false,

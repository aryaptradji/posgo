<x-layout class="mb-0">
    <x-slot:title>Ubah Data Supplier</x-slot:title>
    <x-slot:header>
        <div class="flex mb-2 items-center gap-2 text-sm text-tertiary-title">
            <a href="{{ route('supplier.index') }}"
                class="font-semibold transition-all duration-300 hover:text-primary hover:scale-110 active:scale-90">Supplier</a>
        ...
        >
            <div class="col-span-1 flex flex-col gap-2">
                ...
                <x-textfield x-model="email" x-on:input="validateEmail()" class="focus:ring" x-bind:class="emailError || emailServerError ? 'focus:ring-danger ring ring-danger' : 'focus:ring-primary'" type="email" name="email"
                    placeholder="Masukkan email supplier disin . . ." classCont="mb-2">Email</x-textfield>
